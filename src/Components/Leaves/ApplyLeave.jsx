          ...
          <Grid container spacing={1.0}>
              ...
              >
                ...
                >
                  ...
                  <Select
                    ...
                    value={LeaveType}
                    onChange={(e) => {
                      updateLeavety(e.target.value);
                      var leaveType = e.target.value;
                      UpdateLeaveDetails((leave) => ({
                        ...leave,
                        leaveType: leaveType
                      }));
                      updateMailData((leave) => ({
                        ...leave,
                        subject: "Applying For " + e.target.value + " ( " + profileData.employeeID + " " + profileData.employeeName + "  )"
                      }));
                    }}
                  >
            ...
            <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
              ...
              >
                ...
                <Select
                  ...
                  onChange={(e) => {
                    UpdateSingleOrMultiple(e.target.value);
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              ...
              >
                ...
                >
                  {error.leaveTypeErr ? error.leaveTypeErr + (error.leaveTypeErr ? ',' : '') : ''}
                  {error.noOfDays ? error.noOfDays + (error.noOfDays ? ',' : '') : ''}
                  {error.toAddressesErr ? error.toAddressesErr + (error.toAddressesErr ? ',' : '') : ''}
                  {error.bodyErr ? error.bodyErr + (error.bodyErr ? ',' : '') : ''}
                  {error.fromDateErr ? error.fromDateErr + (error.fromDateErr ? ',' : '') : ''}
                  {error.toDateErr ? error.toDateErr : ''}
                </p>
              </FormControl>
            </Grid>
