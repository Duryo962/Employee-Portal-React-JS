...
function LeavesDetails() {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 140,
      alueFormatter: (params) => formatDate(params.value) ? formatDate(params.value) : ''
    },
    {
      field: 'leaveToDate',
    ...
    <div>
      <Grid container sx={{ flex: 1 }} >
        ...
        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
          <div style={{
            ...
            <Button
              ...
              onClick={fetchEmployeeLeavesDetails}
        ...
        <NotificationComponent
          backgroundColor={notificationData.coloe}
