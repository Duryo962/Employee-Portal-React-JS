...
export default function PrimarySearchAppBar() {
  ...
  const toggleWorkInformation = () => {
    UpdateExpandOptions({
      ...
      skills: false,
      home: false,
      workInformation: !expandOption.workInformation,
      adminAccess: false
    });
  }
  ...
  const toggleAdminAccess = () => {
    UpdateExpandOptions({
      ...
      home: false,
      workInformation: false,
      adminAccess: !expandOption.adminAccess
    });
  };
            ...
            <Grid container spacing={0.5}>
              ...
              <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                <Button
                  ...
                  sx={{
                    height: "30px",
                    backgroundColor: '#144982',
                    '&:hover': {
                      backgroundColor: '#144982'
                    },
                    border: borderColorVisibility.MidnightBlue && '3px solid #65000b'
                  }}
                  onClick={() => {
                    SetThemeColorMidnightBlue('#144982')
                  }}
                >
                  Midnight Blue
                </Button>
              ...
              <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                <Button
                  ...
                  sx={{
                    ...
                    border: borderColorVisibility.NavyBlue && '3px solid #65000b'
                  }}
                  onClick={() => {
                    SetThemeColorNavyBlue("#1975D1")
                  }}
                >
                  Navy Blue
                </Button>
              ...
              <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                <Button
                  ...
                  sx={{
                    ...
                    border: borderColorVisibility.Teal && '3px solid #65000b'
                  }}
                  onClick={() => {
                    SetThemeColorTeal("#008080")
                  }}
                >
                  Teal
                </Button>
              ...
              <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                <Button
                  ...
                  sx={{
                    ...
                    border: borderColorVisibility.CobaltBlue && '3px solid #65000b'
                  }}
                  onClick={() => { SetThemeColorCobaltBlue("#0047AB") }}
                >
                  Cobalt Blue
                </Button>
              </Grid>
              <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                <Button
                  ...
                  fullWidth sx={{
                    ...
                    color: '#FFFF',
                    border: borderColorVisibility.Verdigris && '3px solid #65000b'
                  }}
                  onClick={() => { SetThemeColorVerdigris("#40B5AD") }}
                >
                  Verdigris
                </Button>
              </Grid>
              <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                <Button
                  ...
                  sx={{
                    ...
                    color: '#FFFF',
                    border: borderColorVisibility.RoyalBlue && '3px solid #65000b'
                  }}
                  onClick={() => { SetThemeColorRoyalBlue("#4169E1") }}
                >
                  Royal Blue
                </Button>
              </Grid>
