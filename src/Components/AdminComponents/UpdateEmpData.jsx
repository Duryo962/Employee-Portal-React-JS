        ...
        },
        {
            ...
            renderCell: (params) => (
                <EditIcon
                    ...
                    onClick={() => handleRmTableEditClick(params.row)} />
            ),
        },
    ];
            ...
            <Grid container spacing={1} style={{ flex: 1 }}>
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <Grid container spacing={1}>
                                            ...
                                            <Grid item xs={6} sm={6} md={4} lg={4} xl={4}>
                                                ...
                                                >
                                                    <Button
                                                        ...
                                                        endIcon={<SearchIcon />}
                                                        onClick={handleupdateprofileSearchClick}
                                                    >
                                                        Search
                                                    </Button>
                                                    <Button
                                                        ...
                                                        endIcon={<CancelIcon />}
                                                        onClick={handleupdateprofileClearClick}
                                                    >
                                                        Clear
                                                    </Button>
                                                </div>
                                                ...
                                                <Grid item xs={6} sm={6} md={4} lg={4} xl={4}>
                                                    ...
                                                    >
                                                        <Button
                                                            ...
                                                            endIcon={<SearchIcon />}
                                                            onClick={handleUpdatereportingManagerSearchClick}
                                                        >
                                                            Search
                                                        </Button>
                                                        <Button
                                                            ...
                                                            endIcon={<CancelIcon />}
                                                            onClick={handleupdatereportingManagerClearClick}
                                                        >
                                                            Clear
                                                        </Button>
                                                    </div>
                                                ...
                                                <Grid item xs={6} sm={6} md={4} lg={4} xl={4}>
                                                    ...
                                                    >
                                                        <Button
                                                            ...
                                                            endIcon={<SearchIcon />}
                                                            onClick={handleUpdateShiftTimigsSearchClick}
                                                        >
                                                            Search
                                                        </Button>
                                                        <Button
                                                            ...
                                                            endIcon={<CancelIcon />}
                                                            onClick={handleupdateShiftTimingsClearClick}
                                                        >
                                                            Clear
                                                        </Button>
                                                    </div>
                        ...
                        <Dialog
                            open={dialogBoxVisibility.updateProfileDialog}
                        >
                            <DialogTitle
                                style={{
                                    color: ThemeColor.Color,
                                ...
                                <ListItem>
                                    ...
                                    >
                                        <Button
                                            ...
                                            endIcon={<UpdateIcon />}
                                            onClick={handleUpdateProfileUpdateButton}
                                        >
                                            Update
                                        </Button >
                                        <Button
                                            ...
                                            endIcon={<CancelIcon />}
                                            onClick={handleUpdateprofileCancelButton}
                                        >
                                            Cancel
                                        </Button>
                                    </div>
                        ...
                        <Dialog
                            open={dialogBoxVisibility.updatermDialog}
                        >
                            <DialogTitle
                                style={{
                                    color: ThemeColor.Color,
                                ...
                                <ListItem>
                                    ...
                                    >
                                        <Button
                                            ...
                                            endIcon={<UpdateIcon />}
                                            onClick={handleUpdateRMUpdateButton}
                                        >
                                            Update
                                        </Button >
                                        <Button
                        ...
                        <Dialog
                            open={dialogBoxVisibility.shiftTimingsDialog}
                            fullWidth={true}
                            maxWidth={'sm'}
                        >
                            <DialogTitle
                            ...
                            <List>
                                            ...
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        ...
                                                        value="Monday"
                                                        checked={SelectedRowDays.includes("Monday")}
                                                    />
                                                }
                                                label="Mon"
                                            />
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        onChange={handleSelectedCheckboxChange}
                                                        value="Tuesday"
                                                        checked={SelectedRowDays.includes("Tuesday")}
                                                    />
                                                }
                                                label="Tue"
                                            />
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        onChange={handleSelectedCheckboxChange}
                                                        value="Wednesday"
                                                        checked={SelectedRowDays.includes("Wednesday")}
                                                    />
                                                }
                                                label="Wed"
                                            />
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        onChange={handleSelectedCheckboxChange}
                                                        value="Thursday"
                                                        checked={SelectedRowDays.includes("Thursday")}
                                                    />
                                                }
                                                label="Thu"
                                            />
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        onChange={handleSelectedCheckboxChange}
                                                        value="Friday"
                                                        checked={SelectedRowDays.includes("Friday")}
                                                    />
                                                } label="Fri"
                                            />
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        onChange={handleSelectedCheckboxChange}
                                                        value="Saturday"
                                                        checked={SelectedRowDays.includes("Saturday")}
                                                    />
                                                }
                                                label="Sat"
                                            />
                                            <FormControlLabel
                                                control={
                                                    <Checkbox
                                                        onChange={handleSelectedCheckboxChange}
                                                        value="Sunday"
                                                        checked={SelectedRowDays.includes("Sunday")}
                                                    />
                                                }
                                                label="Sun"
                                            />
                                ...
                                <ListItem>
                                    ...
                                    >
                                        <FormControl
                                            style={{
                                                width: isMobileOrMediumScreen ? "70%" : "50%",
                                                height: "100%"
                                            }}
                                        >
                                            <LocalizationProvider
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        endIcon={<CancelIcon />}
                                        onClick={handleShiftUpdateClearButton}
                                    >
                                        Cancel
                                    </Button>
                                </ListItem>
