...
function CreateProfile() {
    ...
    const getWorkFromLocationListData = async () => {
        if (workFromLocationList.length === 0) {
            try {
                ...
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                            ...
                            >
                                <InputLabel
                                    id="demo-simple-select-helper-label_Designation"
                                >
                                    Designation
                                </InputLabel>
                                <Select
                                    labelId="demo-simple-select-helper-label_Designation"
                                    id="demo-simple-select-helper_designation"
                                    label="Designation"
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                            ...
                            >
                                <InputLabel
                                    id="demo-simple-select-helper-label_reportingManager"
                                >
                                    Reporting Manager
                                </InputLabel>
                                <Select
                                    labelId="demo-simple-select-helper-label_reportingManager"
                                    id="demo-simple-select-helper_reportingManager"
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                            ...
                            >
                                <InputLabel
                                    id="demo-simple-select-helper-label_workFromLocation"
                                >
                                    Workng
                                </InputLabel>
                                <Select
                                    labelId="demo-simple-select-helper-label_workFromLocation"
                                    id="demo-simple-select-helper_workFromLocation"
                                    label="Workng"
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                            ...
                            >
                                <InputLabel
                                    id="demo-simple-select-helper-label_shifttimings"
                                >
                                    Shift Timings
                                </InputLabel>
                                <Select
                                    labelId="demo-simple-select-helper-label_shifttimings"
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            ...
                            >
                                ...
                                >
                                    {errorMessage.empId ? errorMessage.empId + (errorMessage.empId ? ',' : '') : ''}
                                    {errorMessage.empName ? errorMessage.empName + (errorMessage.empName ? ',' : '') : ''}
                                    {errorMessage.designation ? errorMessage.designation + (errorMessage.designation ? ',' : '') : ''}
                                    {errorMessage.emailId ? errorMessage.emailId + (errorMessage.emailId ? ',' : '') : ''}
                                    {errorMessage.mobileNumber ? errorMessage.mobileNumber + (errorMessage.mobileNumber ? ',' : '') : ''}
                                    {errorMessage.doj ? errorMessage.doj + (errorMessage.doj ? ',' : '') : ''}
                                    {errorMessage.rm ? errorMessage.rm + (errorMessage.rm ? ',' : '') : ''}
                                    {errorMessage.working ? errorMessage.working + (errorMessage.working ? ',' : '') : ''}
                                    {errorMessage.shiftTimings ? errorMessage.shiftTimings + (errorMessage.shiftTimings ? ',' : '') : ''}
                                </p>
                            </FormControl>
                        </Grid>
