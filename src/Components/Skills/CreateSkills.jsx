          ...
          <Grid container spacing={0.5}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              ...
              >
                ...
                >
                  {error.companyErr ? error.companyErr + (error.companyErr ? ',' : '') : ''}
                  {error.endDateErr ? error.endDateErr + (error.endDateErr ? ',' : '') : ''}
                  {error.skillsErr ? error.skillsErr + (error.skillsErr ? ',' : '') : ''}
                  {error.startDateErr ? error.startDateErr + (error.startDateErr ? ',' : '') : ''}
                  {error.workErr ? error.workErr + (error.workErr ? ',' : '') : ''}
                </p>
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              <FormControl
                style={{
                  width: isMobileOrMediumScreen ? "40%" : "20%",
                  height: "10%"
                }}
              >
                <Button
