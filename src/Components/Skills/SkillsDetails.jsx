...
function SkillsDetails() {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 140,
      valueFormatter: (params) => formatDate(params.value) ? formatDate(params.value) : ''
    },
    {
      field: 'endDate',
      headerName: 'End Date',
    ...
    {
      field: 'skillsPeriodDays',
      headerName: 'Skills_Period(Days)',
      width: 150,
    },
    {
      field: 'edit',
  ...
  const body = (
    <div>
            ...
            <ListItemButton>
              ...
              >
                ...
                <Select
                  ...
                  label="Woking"
                  value={selectSkill.working}
                  onChange={(e) => {
                    var work = e.target.value;
                    UpdateSelectSkill(prevState => ({
                      ...prevState,
                      working: work
                    }))
                  }
      ...
      <Conformation
        open={conformationVisibility}
        onClose={() => setCnformationVisibility(false)}
